...
export const Navbar: React.FC<Props> = ({ children }) => {
  ...
  return (
    <nav
      className=" linear fixed top-0 flex w-full items-center justify-between bg-white px-[20px] transition-transform duration-300 lg:bg-background lg:px-[34px] xl:px-[80px]"
      style={{
